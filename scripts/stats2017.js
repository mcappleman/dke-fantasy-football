...
var data2017 = [
    ['Majors', 10, 7, 3, 0, 993.18, 867.22, 99.32, 86.72, 75, 35, 0, 6.82, 3.18, 0.18],
    ['Trevor', 10, 7, 3, 0, 943.98, 852.28, 94.40, 85.23, 71, 39, 0, 6.45, 3.55, 0.55],
    ['Matt', 10, 5, 5, 0, 920.56, 892.74, 92.06, 89.27, 65, 45, 0, 5.91, 4.09, -0.91],
    ['Chaz', 10, 4, 6, 0, 836.98, 855.2, 83.70, 85.52, 55, 55, 0, 5.00, 5.00, -1.00],
    ['Sam', 10, 5, 5, 0, 901.28, 836.12, 90.13, 83.61, 63, 47, 0, 5.73, 4.27, -0.73],
    ['Ean', 10, 4, 6, 0, 835.18, 905.46, 83.52, 90.55, 53, 57, 0, 4.82, 5.18, -0.82],
    ['Willis', 10, 6, 4, 0, 866.46, 817.92, 86.65, 81.79, 56, 54, 0, 5.09, 4.91, 0.91],
    ['Basil', 10, 5, 4, 1, 871.96, 879.4, 87.20, 87.94, 57, 52, 1, 5.23, 4.77, -0.23],
    ['Hunter', 10, 5, 4, 1, 812.6, 857.9, 81.26, 85.79, 45, 64, 1, 4.14, 5.86, 0.86],
    ['Sawyer', 10, 6, 4, 0, 826.02, 772.92, 82.60, 77.29, 46, 64, 0, 4.18, 5.82, 1.82],
    ['Ross', 10, 3, 7, 0, 771.86, 880.98, 77.19, 88.10, 38, 72, 0, 3.45, 6.55, -0.45],
    ['Jared', 10, 2, 8, 0, 733.24, 895.16, 73.32, 89.52, 35, 75, 0, 3.18, 6.82, -1.18]
];
