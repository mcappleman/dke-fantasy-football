...
var dataSet = [
    ['Majors', 175, 109, 66, 0, '62.29%', 17394.74, 15926.2, 99.40, 91.01, 1093, 773, 1, '58.57%', '3.72%', 102.5, 72.5, 6.5],
    ['Matt', 174, 103, 71, 0, '59.20%', 16724.84, 15887.22, 96.12, 91.31, 1021, 839, 0, '54.89%', '4.30%', 95.5, 78.5, 7.5],
    ['Basil', 147, 84, 62, 1, '57.14%', 14218.78, 13424.26, 96.73, 91.32, 875, 710, 2, '55.20%', '1.94%', 81.1, 65.9, 2.9],
    ['Hunter', 161, 88, 72, 1, '54.66%', 15282.36, 15234.96, 94.92, 94.63, 942, 797, 2, '54.16%', '0.49%', 87.2, 73.8, 0.8],
    ['Willis', 177, 97, 80, 0, '54.80%', 16651, 16149.46, 94.07, 91.24, 985, 895, 1, '52.39%', '2.41%', 92.7, 84.3, 4.3],
    ['Sam', 176, 85, 91, 0, '48.30%', 16415.06, 15945.6, 93.27, 90.60, 942, 932, 0, '50.27%', '-1.97%', 88.5, 87.5, -3.5],
    ['Trevor', 161, 74, 87, 0, '45.96%', 14885.24, 15245.54, 92.45, 94.69, 846, 863, 0, '49.50%', '-3.54%', 79.7, 81.3, -5.7],
    ['Ross', 146, 66, 80, 0, '45.21%', 13592.38, 13767.24, 93.10, 94.30, 775, 804, 1, '49.08%', '-3.88%', 71.7, 74.3, -5.7],
    ['Sawyer', 177, 89, 88, 0, '50.28%', 16362.46, 16298.48, 92.44, 92.08, 925, 956, 0, '49.18%', '1.11%', 87.0, 90.0, 2.0],
    ['Chaz', 143, 69, 74, 0, '48.25%', 13195.78, 13145.9, 92.28, 91.93, 762, 797, 0, '48.88%', '-0.63%, 69.9', 73.1, -0.9],
    ['Ean', 174, 72, 102, 0, '41.38%', 15614.3, 16532.5, 89.74, 95.01, 837, 1022, 1, '45.03%', '-3.65%, 78.3', 95.7, -6.3],
    ['Jared', 172, 53, 119, 0, '30.81%', 14176.42, 16570.56, 82.42, 96.34, 638, 1204, 0, '34.64%', '-3.82%', 59.6, 112.4, -6.6],
];
