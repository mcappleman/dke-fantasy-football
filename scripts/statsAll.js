...
var dataSet = [
    ['Majors', 175, 109, 66, 0, '62.29%', 17,394.74, 15,926.20, 99.40, 91.01, 1093, 773, 1, '58.57%', '3.72%', 102.5, 72.5, 6.5],
    ['Basil', 147, 84, 62, 1, '57.14%', 14,214.78, 13,425.26, 96.70, 91.33, 873, 712, 2, '55.07%', '2.07%', 81.0, 66.0, 3.0],
    ['Matt', 174, 103, 71, 0, '59.20%', 16,724.84, 15,887.22, 96.12, 91.31, 1022, 838, 0, '54.95%', '4.25%', 95.6, 78.4, 7.4],
    ['Hunter', 161, 88, 72, 1, '54.66%', 15,282.36, 15,234.96, 94.92, 94.63, 942, 797, 2, '54.16%', '0.49%', 87.2, 73.8, 0.8],
    ['Willis', 177, 97, 80, 0, '54.80%', 16,644.00, 16,148.46, 94.03, 91.23, 985, 895, 1, '52.39%', '2.41%', 92.7, 84.3, 4.3],
    ['Sam', 176, 86, 90, 0, '48.86%', 16,415.06, 15,944.60, 93.27, 90.59, 943, 931, 0, '50.32%', '-1.46%', 88.6, 87.4, -2.6],
    ['Ross', 146, 66, 80, 0, '45.21%', 13,591.38, 13,760.24, 93.09, 94.25, 775, 804, 1, '49.08%', '-3.88%', 71.7, 74.3, -5.7],
    ['Trevor', 161, 74, 87, 0, '45.96%', 14,884.24, 15,244.54, 92.45, 94.69, 846, 863, 0, '49.50%', '-3.54%', 79.7, 81.3, -5.7],
    ['Sawyer', 177, 89, 88, 0, '50.28%', 16,362.46, 16,298.48, 92.44, 92.08, 925, 956, 0, '49.18%', '1.11%', 87.0, 90.0, 2.0],
    ['Chaz', 143, 69, 74, 0, '48.25%', 13,196.78, 13,141.90, 92.29, 91.90, 762, 797, 0, '48.88%', '-0.63%', 69.9, 73.1, -0.9],
    ['Ean', 174, 72, 102, 0, '41.38%', 15,613.30, 16,531.50, 89.73, 95.01, 838, 1021, 1, '45.08%', '-3.70%', 78.4, 95.6, -6.4],
    ['Jared', 172, 52, 120, 0, '30.23%', 14,175.42, 16,570.56, 82.42, 96.34, 637, 1205, 0, '34.58%', '-4.35%', 59.5, 112.5, -7.5],
];
