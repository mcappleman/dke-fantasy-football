...
var dataSet = [
    ['Majors', 147, 90, 57, 0, '61.22%', 14540.18, 13456.08, 98.91, 91.54, 914, 657, 0, '58.18%', '3.04%', 85.5, 61.5, 4.5],
    ['Matt', 147, 90, 57, 0, '61.22%', 14256.04, 13321.48, 96.98, 90.62, 879, 692, 0, '55.95%', '5.27%', 82.2, 64.8, 7.8],
    ['Willis', 149, 84, 65, 0, '56.38%', 14145.42, 13603.7, 94.94, 91.30, 855, 730, 0, '53.94%', '2.43%', 80.4, 68.6, 3.6],
    ['Hunter', 133, 75, 57, 1, '56.39%', 12597.5, 12460.34, 94.72, 93.69, 779, 664, 2, '53.98%', '2.41%', 71.8, 61.2, 3.2],
    ['Sawyer', 150, 72, 78, 0, '48.00%', 13734.58, 13836.94, 91.56, 92.25, 751, 841, 0, '47.17%', '0.83%', 70.8, 79.2, 1.2],
    ['Sam', 149, 71, 78, 0, '47.65%', 13849.44, 13358.64, 92.95, 89.66, 775, 810, 0, '48.90%', '-1.24%', 72.9, 76.1, -1.9],
    ['Basil', 119, 69, 49, 1, '57.98%', 11555.16, 10929.62, 97.10, 91.85, 717, 573, 1, '55.58%', '2.41%', 66.1, 52.9, 2.9],
    ['Trevor', 133, 61, 72, 0, '45.86%', 12476.84, 12804.8, 93.81, 96.28, 732, 681, 0, '51.80%', '-5.94%', 68.9, 64.1, -7.9],
    ['Ean', 146, 58, 88, 0, '39.73%', 13003.44, 13894.92, 89.06, 95.17, 692, 871, 1, '44.28%', '-4.55%', 64.6, 81.4, -6.6],
    ['Ross', 119, 56, 63, 0, '47.06%', 11094.52, 11204.52, 93.23, 94.16, 633, 658, 0, '49.03%', '-1.97%', 58.3, 60.7, -2.3],
    ['Chaz', 115, 53, 62, 0, '46.09%', 10513.18, 10523.94, 91.42, 91.51, 605, 658, 0, '47.90%', '-1.81%', 55.1, 59.9, -2.1],
    ['Jared', 144, 44, 100, 0, '30.56%', 11920.4, 13906.28, 82.78, 96.57, 549, 997, 0, '35.51%', '-4.96%', 51.1, 92.9, -7.1]
];
