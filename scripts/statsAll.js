...
var dataSet = [
    ['Majors', 158, 97, 61, 0, '61.39%', 15605.3, 14581.96, 98.77, 92.29, 956, 728, 0, '56.77%', '4.62%', 89.7, 68.3, 7.3],
    ['Matt', 157, 95, 62, 0, '60.51%', 15290.5, 14327.84, 97.39, 91.26, 942, 735, 0, '56.17%', '4.34%', 88.2, 68.8, 6.8],
    ['Willis', 159, 89, 70, 0, '55.97%', 15199.22, 14561.34, 95.59, 91.58, 907, 783, 1, '53.67%', '2.31%', 85.3, 73.7, 3.7],
    ['Hunter', 143, 79, 63, 1, '55.24%', 13544.74, 13467.26, 94.72, 94.18, 834, 715, 2, '53.84%', '1.41%', 77.0, 66.0, 2.0],
    ['Sawyer', 160, 78, 82, 0, '48.75%', 14701.48, 14788.1, 91.88, 92.43, 804, 894, 0, '47.35%', '1.40%', 75.8, 84.2, 2.2],
    ['Basil', 129, 74, 54, 1, '57.36%', 12570.16, 11908.48, 97.44, 92.31, 782, 614, 1, '56.01%', '1.35%', 72.3, 56.7, 1.7],
    ['Sam', 159, 74, 85, 0, '46.54%', 14740.1, 14353.72, 92.71, 90.27, 821, 870, 0, '48.55%', '-2.01%', 77.2, 81.8, -3.2],
    ['Trevor', 144, 68, 76, 0, '47.22%', 13520.16, 13778.18, 93.89, 95.68, 784, 742, 0, '51.38%', '-4.15%', 74.0, 70.0, -6.0],
    ['Ean', 156, 65, 91, 0, '41.67%', 14138.46, 14904.12, 90.63, 95.54, 765, 904, 1, '45.84%', '-4.17%', 71.5, 84.5, -6.5],
    ['Ross', 129, 59, 70, 0, '45.74%', 12098.98, 12241.98, 93.79, 94.90, 687, 709, 1, '49.21%', '-3.48%', 63.5, 65.5, -4.5],
    ['Chaz', 126, 59, 67, 0, '46.83%', 11597.02, 11628.44, 92.04, 92.29, 660, 716, 0, '47.97%', '-1.14%', 60.4, 65.6, -1.4],
    ['Jared', 155, 48, 107, 0, '30.97%', 12847.64, 14926.9, 82.89, 96.30, 588, 1071, 0, '35.44%', '-4.48%', 54.9, 100.1, -6.9],
];
