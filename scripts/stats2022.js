...
var data2022 = [
    ['Majors', 6, 5, 1, 0, 661.56, 495.84, 110.26, 56, 10, 0, '84.85%', 5.09, 0.91, -0.09],
    ['Chaz', 6, 6, 0, 0, 617.7, 474.5, 102.95, 48, 18, 0, '72.73%', 4.36, 1.64, 1.64],
    ['Sam', 6, 4, 2, 0, 553.28, 533.74, 92.21, 41, 25, 0, '62.12%', 3.73, 2.27, 0.27],
    ['Sawyer', 6, 4, 2, 0, 577.7, 526.98, 96.28, 40, 26, 0, '60.61%', 3.64, 2.36, 0.36],
    ['Ross', 6, 2, 4, 0, 546.94, 593.58, 91.16, 33, 33, 0, '50.00%', 3.00, 3.00, -1.00],
    ['Hunter', 6, 2, 4, 0, 545.86, 598.7, 90.98, 32, 34, 0, '48.48%', 2.91, 3.09, -0.91],
    ['Basil', 6, 2, 4, 0, 518.84, 484.9, 86.47, 31, 35, 0, '46.97%', 2.82, 3.18, -0.82],
    ['Willis', 6, 3, 3, 0, 563.38, 542.4, 93.90, 31, 35, 0, '46.97%', 2.82, 3.18, 0.18],
    ['Ean', 6, 3, 3, 0, 507.32, 561.36, 84.55, 26, 40, 0, '39.39%', 2.36, 3.64, 0.64],
    ['Jared', 6, 1, 5, 0, 508.64, 627.04, 84.77, 25, 41, 0, '37.88%', 2.27, 3.73, -1.27],
    ['Trevor', 6, 2, 4, 0, 503.9, 554.44, 83.98, 22, 44, 0, '33.33%', 2.00, 4.00, 0.00],
    ['Matt', 6, 2, 4, 0, 434.44, 546.08, 72.41, 11, 55, 0, '16.67%', 1.00, 5.00, 1.00],
];
