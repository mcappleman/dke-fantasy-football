...
var data2022 = [
    ...
    ['Chaz', 6, 6, 0, 0, 618.7, 470.5, 103.12, 78.42, 48, 18, 0, '72.73%', 4.36, 1.64, 1.64],
    ['Sam', 6, 5, 1, 0, 553.28, 532.74, 92.21, 88.79, 42, 24, 0, '63.64%', 3.82, 2.18, 1.18],
    ['Sawyer', 6, 4, 2, 0, 577.7, 526.98, 96.28, 87.83, 40, 26, 0, '60.61%', 3.64, 2.36, 0.36],
    ['Ross', 6, 2, 4, 0, 545.94, 586.58, 90.99, 97.76, 33, 33, 0, '50.00%', 3.00, 3.00, -1.00],
    ['Hunter', 6, 2, 4, 0, 545.86, 598.7, 90.98, 99.78, 32, 34, 0, '48.48%', 2.91, 3.09, -0.91],
    ['Willis', 6, 3, 3, 0, 556.38, 541.4, 92.73, 90.23, 31, 35, 0, '46.97%', 2.82, 3.18, 0.18],
    ['Basil', 6, 2, 4, 0, 514.84, 485.9, 85.81, 80.98, 29, 37, 0, '43.94%', 2.64, 3.36, -0.64],
    ['Ean', 6, 3, 3, 0, 506.32, 560.36, 84.39, 93.39, 27, 39, 0, '40.91%', 2.45, 3.55, 0.55],
    ['Jared', 6, 0, 6, 0, 507.64, 627.04, 84.61, 104.51, 24, 42, 0, '36.36%', 2.18, 3.82, -2.18],
    ['Trevor', 6, 2, 4, 0, 502.9, 553.44, 83.82, 92.24, 22, 44, 0, '33.33%', 2.00, 4.00, 0.00],
    ['Matt', 6, 2, 4, 0, 434.44, 546.08, 72.41, 91.01, 12, 54, 0, '18.18%', 1.09, 4.91, 0.91],
];
